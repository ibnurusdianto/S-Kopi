...
function Footer() {
    ...
    return (
        <footer className="bg-background border-t border-gray-200 dark:border-neutral-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <Link href="/" className="text-2xl font-bold text-foreground tracking-tight flex items-center gap-3 mb-4">
                            <Image 
                                src="/logo/logo.png" 
                                alt="Logo Sasa Kopi" 
                                width={100} 
                    ...
                    <div className="flex flex-col md:items-end">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            {webSettings?.socialLinks?.facebook && (
                                <a href={`https://facebook.com/${webSettings.socialLinks.facebook}`} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" aria-label="Facebook">
                            ...
                            {webSettings?.socialLinks?.instagram && (
                                <a href={`https://instagram.com/${webSettings.socialLinks.instagram}`} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-pink-600 dark:hover:text-pink-400 transition-colors" aria-label="Instagram">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="border-t border-gray-200 dark:border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-6">
                        <Link href="/privasi" className="text-gray-500 dark:text-gray-400 hover:text-foreground transition-colors text-sm">
                            Kebijakan Privasi
                        </Link>
                        <Link href="/ketentuan" className="text-gray-500 dark:text-gray-400 hover:text-foreground transition-colors text-sm">
                            Syarat & Ketentuan
                        </Link>
                    </div>
                </div>
