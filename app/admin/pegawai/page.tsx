            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-neutral-800 max-w-xl text-gray-900 dark:text-white">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value={currentPegawai.password || ""} onChange={e => setCurrentPegawai({...currentPegawai, password: e.target.value})} className="w-full bg-transparent border border-gray-200 dark:border-neutral-700 rounded-lg px-3 py-2 focus:outline-none focus:border-amber-500" placeholder="Kosongkan jika tidak diubah" />
